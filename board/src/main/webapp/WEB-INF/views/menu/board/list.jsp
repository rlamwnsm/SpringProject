                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-bordered table-hover" >
                             ...
                             <form id='actionForm' action="/menu/board/list" method='get'>
                            ...
                            <form id='searchForm' action="/menu/board/list" method='get'>
                            	<select name='type'>
	...
	(
		function() 
		{
			...
			(
				"click", function() 
				{
					self.location = "/menu/board/register";
				}
			);	
			...
			$(".move").on("click", function(e){
				...
				actionForm.attr("action", "/menu/board/read");
				actionForm.submit();
			});
